    ...
    def _initialize_local_llm_replica(
        ...
        try:
            ...
            with self._replica_launch_lock:
                # Keep the per-stage environment active until the spawned
                # engine core has completed its startup handshake.  Applying
                # runtime.env only in the orchestrator is insufficient:
                # model-runner components such as RuntimePolicyClient are
